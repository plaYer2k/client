...
ConVar asw_backgroundmovie_enable("asw_backgroundmovie_enable", "1", FCVAR_ARCHIVE , "Enables or Disables the background movie in your mainmenu. 1 = enabled, 0 = disabled");
...
void CNB_Header_Footer::PaintBackground()
{
	...
	if ( m_bMovieEnabled && ASWBackgroundMovie() && (asw_backgroundmovie_enable.GetFloat() >= 1) )
	{
